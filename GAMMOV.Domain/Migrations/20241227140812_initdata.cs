        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Link = table.Column<string>(type: "nvarchar(750)", maxLength: 750, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MetaTitle = table.Column<string>(type: "nvarchar(180)", maxLength: 180, nullable: false),
                    OgUrl = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    OgImg = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeoDataId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WebDeveloper = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    SeoDataId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SiteSettings_SocialMedia_SocialMediaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PostVisit = table.Column<int>(type: "int", nullable: true),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SeoDataId = table.Column<int>(type: "int", nullable: false),
                    IsSelectedSite = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SiteSettings_SocialMediaId",
                table: "SiteSettings",
