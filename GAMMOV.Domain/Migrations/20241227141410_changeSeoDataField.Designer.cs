...
namespace GAMMOV.DataLayer.Migrations
{
    ...
    [Migration("20241227141410_changeSeoDataField")]
    partial class changeSeoDataField
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GAMMOV.DataLayer.Entities.SeoData", b =>
                {
                    b.HasOne("GAMMOV.DataLayer.Entities.Category", "Category")
                        .WithOne("SeoData")
                        .HasForeignKey("GAMMOV.DataLayer.Entities.SeoData", "CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GAMMOV.DataLayer.Entities.Post", "Post")
                        .WithOne("SeoData")
                        .HasForeignKey("GAMMOV.DataLayer.Entities.SeoData", "PostId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GAMMOV.DataLayer.Entities.SiteSetting", "SiteSetting")
                        .WithOne("SeoData")
                        .HasForeignKey("GAMMOV.DataLayer.Entities.SeoData", "SiteSettingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GAMMOV.DataLayer.Entities.Tag", "Tag")
                        .WithOne("SeoData")
                        .HasForeignKey("GAMMOV.DataLayer.Entities.SeoData", "TagId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
